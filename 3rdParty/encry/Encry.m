...
+(NSString*) Md5EncrySign:(NSString*)rd withTimeStamp:(NSString*)timestamp withImei:(NSString*)imei{
	...
	NSString *str1 = [[[str stringByAppendingString: timestamp] stringByAppendingString:imei] stringByAppendingString:serviceSignSecureKey];
...
+ (NSString*) Md5EncrySign:(NSString*)key withTimeStamp:(NSString*)timestamp{
    
	NSString *str1 = [key stringByAppendingString: timestamp];
