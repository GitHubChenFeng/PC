    ...
    [UIView transitionFromView:(displayingPrimary ? self.primaryView : self.secondaryView)
                    ...
                    completion:^(BOOL finished) {
                        if (finished) {
                            ...
                            if (self.delegate != nil && [self.delegate respondsToSelector:@selector(clickCoinViewHandle:)]) {
                                UIView *senderView = displayingPrimary ? self.primaryView : self.secondaryView;
                                
                                [self.delegate performSelector:@selector(clickCoinViewHandle:) withObject:senderView];
                            }
